...
class ScholarlyProductType(Enum):
    ...
    CONFERENCE_PRESENTATIONS="Conference presentation(s)"
    CONFERENCE_PROCEEDINGS="Conference proceeding(s)"
    COURSE_DESIGN="Course design"
    CREATIVE_PRODUCTS="Creative product(s)"
    CURRICULUM_A_DATA="Curriculum(a) Data"
    EDITED_BOOKS="Edited book(s)"
    EXHIBITS="Exhibit(s)"
    LECTURES="Lecture(s)"
    INVENTIONS_OR_PRODUCTS="Invention(s) or Product(s)"
    MONOGRAPHS="Monograph(s)"
    NON_CREDIT_COURSES="Non-credit course(s)"
    PATENTS="Patent(s)"
    PERFORMANCES="Performance(s)"
    TECHNICAL_REPORTS="Technical report(s)"
    PROGRAM_EVALUATIONS="Program evaluation(s)"
    WEBSITES="Website(s)"
    VIDEOS_FILMS="Video(s)/Film(s)"
    WHITE_PAPERS="White paper(s)"
    OTHER="Other"

class ScholarshipTypes(Enum):
    QUALITATIVE="Qualitative"
    QUANTITATIVE="Quantitative"
    MIXED_MULTIPLE_METHODS="Mixed/Multiple methods"
    CREATIVE_ACTIVITY="Creative activity"
    OTHER="Other"

class StudentInvolvement(Enum):
    ASSISTANTSHIP="Assistantship"
    CORPORATION_FOR_NATIONAL_AND_COMMUNITY_SERVICE="Corporation for National and Community Service"
    FELLOWSHIP="Fellowship"
    GRADUATE_RESEACH="Graduate research"
    INTERNSHIP="Internship (community-based)"
    STUDENT_EMPLOYEE="Student employee (e.g., peer reflection leader, work study, etc.)"
